...
public class Concordance {
                ...
                for (String word : words) {
                    if (!word.isEmpty()) {
                        ...
                        // else add new entry
                            ...
                            results.put(word.toLowerCase(), entry);
                        }
                    }
                }
            }
    ...
    private static void printMap(Map<String, Entry> fullMap) {
        for (Map.Entry<String, Entry> entry : fullMap.entrySet()) {
            System.out.printf("word: %s%s", entry.getKey(), entry.getValue());
        }
    }
    ...
    public static void main(String[] args) {
        for (String fileName : args) {
            try {
                System.out.printf("%s:\n", fileName);
                Map<String, Entry> results = generateConcordanceForFile(fileName);
                printMap(results);
